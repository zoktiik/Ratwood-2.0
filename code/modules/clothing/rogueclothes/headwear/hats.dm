...
/obj/item/clothing/head/roguetown/armingcap
	...
	flags_inv = HIDEEARS
	nudist_approved = TRUE
	salvage_result = /obj/item/natural/cloth // sewn from cloth, not hide
	fiber_salvage = FALSE
	//dropshrink = 0.75
	cold_protection = HEAD
...
/obj/item/clothing/head/roguetown/headband
	...
	nudist_approved = TRUE
	fiber_salvage = FALSE // sewn from cloth alone; default fiber refund would mint a free fiber
...
/obj/item/clothing/head/roguetown/headband/monk
	...
	fiber_salvage = TRUE // padded recipe includes fibers; parent headband does not
